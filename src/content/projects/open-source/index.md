...
1. [Pull Request #1478 in `music-assistant/frontend` -- Vuetify Unit Test Setup and Basic Unit Test for `<InfoHeader />` Component](https://github.com/music-assistant/frontend/pull/1478)