...
Guidance on how to set and query the TX power of ESP32 Thread devices can be found in the documentations provided by OpenThread and Espressif. I wanted to write a quick guide that gathered the information provided by the documentations in a single place, along with providing references to some examples.
