...
These inaccurate low current measurements occur when the **J5 header** pin of the ESP32-H2 has *not* been removed.

<figure>
  <img src="/images/esp32-energy/esp32h2-j5-header.png" /> 
  <figcaption>
    The ESP32-H2 when the J5 header pin. The power-on LED if off when the J5 header pin was removed, even though the ESP32-H2 module itself is having its power supplied by USB.
  </figcaption>
</figure>


{/* The J5 header is used to connect the ESP32-H2 SoC to the GPIO pins of the rest of the devkit. When the J5 header pin is removed, the  */}
