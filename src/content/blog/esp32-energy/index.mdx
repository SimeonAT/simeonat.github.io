...
You set up the ESP32 with the PPK2 by using jumper wires to connect the `VCC` port of the PPK2 to the `5V0` pin of the ESP32 device, and another jumper wire to connect the `GND` port of the PPK2 to `GND` pin on the ESP32. 
