...
In this configuration, you can use the PPK2 to measure the current of the ESP32 device while the PPK2 itself is providing 5V of power. This is how I initially approached the measurement of my ESP32-H2 device.
