...
<figure>
  ...
  <figcaption>
    When the ESP32-H2 runs to the [ESP32 OpenThread boilerplate deep sleep SED program](https://github.com/espressif/esp-idf/tree/master/examples/openthread/ot_sleepy_device/deep_sleep) and has its `5V0` pin connected to the `VCC` port of the PPK2, the current measured by the PPK2 is around ~1.21 mA, rather than ~7 uA.
  </figcaption>
</figure>
...
<figure>
  ...
  <figcaption>
    The J5 header of the ESP32-H2. The power-on LED if off when the J5 header jumper was removed, even though the ESP32-H2 module itself was having its power supplied by USB.
  </figcaption>
</figure>
