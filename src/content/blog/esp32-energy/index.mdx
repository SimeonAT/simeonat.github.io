...
* Connect the `VCC` port of the PPK2 to the `3V3`[^5] pin of the ESP32-H2, or one of the two pins that are visible when the J5 header pin has been removed.
