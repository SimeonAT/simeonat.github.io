...
In order to accurately measure the current of an ESP32-H2, the J5 jumper will need to be removed [^3] from the ESP32-H2 for the duration in which the PPK2 is measuring the current of the device.

## Measuring Small Currents Correctly

To properly measure low currents using the PPK2, we will need the following setup:

* Connect the `VCC` port of the PPK2 to the `3V3`[^5] pin of the ESP32-H2, or to one of the two J5 pins that are visible when the J5 jumper has been removed.
