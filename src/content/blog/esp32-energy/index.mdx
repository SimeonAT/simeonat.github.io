...
<figure>
  ...
  <figcaption>
    The waveforms displayed when measuring the deep sleep current of an ESP32-H2 using the Digilent Analog Discovery 3 (AD3) oscilloscope, with the AD3 Current & Power Adapter extension. The expected deep sleep current of the ESP32 should be ~7 uA, but the noise prevents waveforms from being shown at uA granularity.
  </figcaption>
</figure>
